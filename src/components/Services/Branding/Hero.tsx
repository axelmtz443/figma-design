...
export default function Hero() {
  ...
  return (
    ...
    <section className="relative w-full bg-black h-screen min-h-screen flex items-center justify-center overflow-hidden pt-32 pb-20 px-6 md:px-12 lg:px-24 z-10">      <style>{`
