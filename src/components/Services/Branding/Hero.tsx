...
export default function Hero() {
  ...
  return (
    ...
    <section className="relative w-full min-h-screen flex flex-col items-center justify-center overflow-hidden py-28 md:py-36 px-6 md:px-12 lg:px-24 bg-black">      <style>{`
