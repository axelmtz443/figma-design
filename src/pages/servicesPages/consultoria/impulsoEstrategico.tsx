    ...
    <section className="w-full py-16 sm:py-20 lg:py-24 px-4 sm:px-6 md:px-10 lg:px-12 xl:px-20 bg-transparent">
      ...
      <div className="w-full max-w-7xl mx-auto">
        <div className="flex flex-col lg:flex-row gap-6 sm:gap-8 lg:gap-10 items-stretch">
          ...
          {/* Contenido dinámico */}
          <div className="w-full lg:w-3/5 bg-white/[0.03] backdrop-blur-[20px] border border-white/[0.08] p-6 sm:p-8 md:p-10 lg:p-12 rounded-[2rem] min-h-[450px] sm:min-h-[500px] relative overflow-hidden flex flex-col justify-center">
            
            {/* Glow de fondo */}
            <div 
              className={`absolute top-[-20%] right-[-10%] w-[300px] sm:w-[400px] h-[300px] sm:h-[400px] blur-[100px] rounded-full transition-all duration-700 pointer-events-none ${activeData.theme.glow}`}
            />
              ...
              <div className="flex-grow">
                ...
                <ul className="grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-3 md:gap-4 text-zinc-400 mb-6 sm:mb-8 md:mb-10">
                  {activeData.items.map((item, i) => (
                    ...
                    >
                      <div 
                        className={`w-1.5 h-1.5 sm:w-2 sm:h-2 rounded-full mt-1.5 shrink-0 ${activeData.theme.bg} ${activeData.theme.shadow}`} 
                      />
