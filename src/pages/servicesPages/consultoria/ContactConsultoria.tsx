      ...
      {sent ? (
              ...
              <form onSubmit={handleSubmit} className="flex flex-col gap-4 sm:gap-5">
                ...
                <button
                  type="submit"
                  disabled={sending}
                  className="mt-2 w-full relative text-white font-montserrat font-semibold text-sm sm:text-base px-6 py-3 sm:py-4 rounded-xl transition-all duration-300 hover:opacity-90 flex items-center justify-center gap-2 disabled:opacity-60"
                  style={{
